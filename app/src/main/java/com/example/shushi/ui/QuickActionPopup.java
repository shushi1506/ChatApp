...
public class QuickActionPopup extends MyPopupWindow implements OnDismissListener {
    ...
    private int posItemParent;
    private View viewItemParent;
    ...
    public void setPosItemParent(int posItemParent) {
        this.posItemParent = posItemParent;
    }

    public int getPosItemParent() {
        return posItemParent;
    }

    public void setViewItemParent(View viewItemParent) {
        this.viewItemParent = viewItemParent;
    }

    public View getViewItemParent() {
        return viewItemParent;
    }
     ...
     *
     */
    public void show (View anchor,int posParent) {
        this.setViewItemParent(anchor);
        this.setPosItemParent(posParent);
        preShow();
